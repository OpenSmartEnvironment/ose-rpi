...
This package contains [entry kinds](http://opensmartenvironment.github.io/doc/#entrykinds) for integrating hardware from
the Raspberry Pi Foundation into OSE.

See [Raspberry Pi example](http://opensmartenvironment.github.io/doc/#raspberrypiexample).

## Important links
This package is a part of the OSE suite. For more information, see the following links:
- [Raspberry Pi documentation](http://opensmartenvironment.github.io/doc/#rpi)
